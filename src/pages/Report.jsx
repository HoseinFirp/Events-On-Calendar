...
function Report() {
  ...
  return (
    <>{warning?
      <Warning
        children={"مشکلی در دریافت اطلاعات بوجود آمده... دوباره تلاش کنید"}
      />
    :null
    }
      {!loading ? (
        <button
          className="mt-10 flex justify-center gap-3 items-center"
          onClick={handleGetList}
        >
          <HiMiniArrowPath /> بروز رسانی صفحه
        </button>
      ) : null}
        ...
        {loading ? (
          ...
          list?.map((data) => (
            ...
            >
              ...
              <p className="text-white text-2xl font-semibold  mb-4 flex justify-end">
                {data.text}
              </p>
